...
class DatabaseHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTable =
            "CREATE TABLE $TABLA_ARTICULOS ($KEY_ID INTEGER PRIMARY KEY, $COLUMN_NOMBRE TEXT, $COLUMN_TIPO TEXT, $COLUMN_PRECIO INTEGER, $COLUMN_URI_IMAGEN TEXT)"
    ...
    fun getArticulos(): ArrayList<Articulo>{
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                val uri = cursor.getString(cursor.getColumnIndex(COLUMN_URI_IMAGEN))
